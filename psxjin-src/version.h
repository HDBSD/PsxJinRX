...
#ifdef _DEBUG
#define PCSXRR_SUBVERSION_STRING " DEV"
#elif defined(PUBLIC_RELEASE)
#define PCSXRR_SUBVERSION_STRING ""
#else
#define PCSXRR_SUBVERSION_STRING " INTERNAL"
#endif
...
#define PCSXRR_VERSION_STRING "v1.0" PCSXRR_SUBVERSION_STRING PCSXRR_FEATURE_STRING PCSXRR_COMPILER
